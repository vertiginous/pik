...
describe SearchPath do
  ...
  describe "#push" do
    ...
    it "should add an element to the end" do
      blank_path = SearchPath.new('')
      blank_path.join.should == ('')
      blank_path.push('C:\users\gthiesfeld\.pik\gems\ruby-187-p249')
      blank_path.join.should == ('C:\users\gthiesfeld\.pik\gems\ruby-187-p249')
      blank_path.push('C:\users\gthiesfeld\.pik\gems\ruby-187-p249@global')
      blank_path.join.should == ('C:\users\gthiesfeld\.pik\gems\ruby-187-p249;C:\users\gthiesfeld\.pik\gems\ruby-187-p249@global')
    end
  end
